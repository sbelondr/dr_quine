...
char *le="%1$sl5,b,q,b,b,n);%c%1$sl7,l6,l6,n);%1$sla,l6,n);%1$slb,l6,l6,n);%c";
char *lf="%1$sld,l6,n,l6);%1$sle,l6,n,n);%1$slf,l6,n);%2$creturn 0;%2$c}%2$c";
char n='\n', q='"', b='\\';
printf(l1,n);printf(l2,n);
...
printf(ld,l6,n,l6);printf(le,l6,n,n);printf(lf,l6,n);
return 0;
}
